...
const placeorder =async (req,res)=>{
    const frontend_url = "https://food-del-tomato-xkby.vercel.app"
  try {
    ...
    res.json({ success: false, message: "Error in placing order", error: error.message });
  }
}
...
const listOrders = async (req,res)=>{
    try {
      ...
      console.log(error)
      res.json({success:false,message:"Error in listing order"})
    }
}
